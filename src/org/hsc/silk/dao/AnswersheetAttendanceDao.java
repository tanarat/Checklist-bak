...
public class AnswersheetAttendanceDao {
	public String tag  = this.getClass().getName();
//	private DbHelper dbHelper;
	private SQLiteDatabase db;
	
	public AnswersheetAttendanceDao(SQLiteDatabase db){
//		this.db = App.getDatabase();
		this.db = db;
	}
//	public AnswersheetAttendanceDao(DbHelper dbHelper){
...
//	}
	public void delete(int answersheetId){
		...
		Log.i(tag, "Delete Answersheet_Attendance (" + rows + " rows)");
	}
	public void insert(int answersheetId, List<String> attendances) {
		// TODO Auto-generated method stub
		for (String attendance : attendances) {
			insert(answersheetId, attendance);
		}
	}
	public void insert(int answersheetId, String attendance){
		ContentValues values = new ContentValues();
		values.put(COLUMN_ANSWERSHEET_ID, answersheetId);
		values.put(COLUMN_ATTENDANCE_NAME, attendance);
		db.insert(TABLE_NAME, null, values);
		Log.i(tag, "Insert Answersheet_Attendance : " + values);
	}
	public void update(int answersheetId, String attendance){
		ContentValues values = new ContentValues();
		values.put(COLUMN_ANSWERSHEET_ID, answersheetId);
		values.put(COLUMN_ATTENDANCE_NAME, attendance);
		db.update(TABLE_NAME, values, COLUMN_ANSWERSHEET_ID + " = " + answersheetId, null);
		Log.i(tag, "Update Answersheet_Attendance : " + values);
	}
	...
	public static String TABLE_NAME = "ANSWERSHEET_ATTENDANCE";
	public static String COLUMN_ANSWERSHEET_ID = "ANSWERSHEET_ID";
	public static String COLUMN_ATTENDANCE_NAME = "ATTENDANCE_NAME";
	public static String[] COLUMNS = { COLUMN_ANSWERSHEET_ID, COLUMN_ATTENDANCE_NAME };

	public static String CREATE_TABLE = "CREATE TABLE "+ TABLE_NAME + "("
			+ COLUMN_ANSWERSHEET_ID + " INTEGER NOT NULL , "
			+ COLUMN_ATTENDANCE_NAME + " TEXT )";
